...
func (s *SmartContract) initLedger(APIstub shim.ChaincodeStubInterface) sc.Response {
	Produces := []Produce{
		Produce{ ProduceName: "Apple", Health: " Insect Pests", Owner : "Tomoko",FarmID:"FARM101"},
		Produce{ ProduceName: "Tomato", Health: "Good", Owner : "Brad",FarmID:"FARM102"},
		Produce{ ProduceName: " Corn", Health: " Insect Pests", Owner : "Jin Soo",FarmID:"FARM104"},
		Produce{ ProduceName: "Cotton", Health: "Very Good", Owner : "Max",FarmID:"FARM105"},
		Produce{ ProduceName: "Orange", Health: "Very Good", Owner : "Adriana",FarmID:"FARM103"},
		Produce{ ProduceName: "Corn", Health: "Good", Owner : "Michel",FarmID:"FARM106"},
		Produce{ ProduceName: "Rice", Health: "Very Good", Owner : "Aarav",FarmID:"FARM107"},
		Produce{ ProduceName: "PeaNuts", Health: "Very Good", Owner : "Pari",FarmID:"FARM108"},
		Produce{ ProduceName: "broccoli", Health: "Good", Owner : "Valeria",FarmID:""},
		Produce{ ProduceName: "pumpkin", Health: "Very Good", Owner : "Shotaro",FarmID:"FARM109"},
	}
