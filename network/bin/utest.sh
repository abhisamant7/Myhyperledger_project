...
# $1 = org name e.g., dfarmadmin | dfarmretail
...
if [ "$1" == "utest" ]; then
    ...
    # Set the org context to Dfarmadmin
    set_test_case   "Test set_org_context for 'dfarmadmin'"
    set_org_context "dfarmadmin"
    assert_equal    "dfarmadmin"  $ORGANIZATION_CONTEXT

    # Set the org context to Dfarmadmin
    set_test_case   "Test set_org_context for 'dfarmretail'"
    set_org_context "dfarmretail"
    assert_equal    "dfarmretail"  $ORGANIZATION_CONTEXT
