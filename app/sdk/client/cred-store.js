...
async function main(){
    ...
    if(org == 'dfarmadmin'){
        // Dfarmadmin client setup
        client.loadFromConfig(DFARMADMIN_CLIENT_CONNECTION_PROFILE_PATH)
    } else if(org == 'dfarmretail'){
        // Dfarmretail client setup
...
function getCertPath(org, user) {
    //dfarmretail.com/users/Admin@dfarmretail.com/msp/signcerts/Admin@dfarmretail.com-cert.pem"
...
function getPrivateKeyPath(org, user) {
    // ../crypto/crypto-config/peerOrganizations/dfarmretail.com/users/Admin@dfarmretail.com/msp/keystore/05beac9849f610ad5cc8997e5f45343ca918de78398988def3f288b60d8ee27c_sk
...
/**
 * Creates the MSP ID from the org name for 'dfarmadmin' it will be 'DfarmadminMSP'
 * @param {string} org 
 */
